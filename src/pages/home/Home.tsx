  ...
  return (
    <>
      ...
      <main className={styles.homePage}>
        ...
        <ul>
          <li>
            Explore our crystal-clear waters with snorkeling, diving, and sunset
            cruises.
          </li>
          <li>
          ...
          <li>
            Taste the island — from fresh seafood to traditional Tanitian dishes
            and tropical fruit.
          </li>
        </ul>
        <p>
          Come for the sunshine, stay for the aloha. Taniti Island is more than
          a vacation — it's an experience you’ll never forget.
        </p>
